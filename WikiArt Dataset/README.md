...
and the csv file can be downloaded at [this https URL](sftp://cschan@web.fsktm.um.edu.my/home/cschan/public_html/source/ICIP2017/wikiart.zip). In the csv files, each row in the list contains (path/to/image.jpg, class_index)
