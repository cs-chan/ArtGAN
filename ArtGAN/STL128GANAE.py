...
gen_dir, real_dir, gen_dir128 = createfolders("./genimgs/STL128GANAE", "/gen", "/real", "/gen128")
...
test = validation_loader(testmanifest, root_files, be, h=im_size[0], w=im_size[1], scale=[0.875, 0.875])
